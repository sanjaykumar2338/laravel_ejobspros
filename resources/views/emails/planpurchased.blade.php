                  ...
                  <center class="">
                     <table cellpadding="0" cellspacing="0" class="w320" style="margin: 0 auto;" width="600">
                        ...
                        <tbody style="margin-top: 15px;">
                           ...
                           <tr class="">
                              <td class="headline">Dear {{$user->name}},</td>
                           </tr>
                           <tr>
                              <td>
                                 <center class="">
                                       ...
                                       <tbody class="">
                                          <tr class="">
                                             <td class="" style="color:#444; font-weight: 400;text-align: left;"><br><br>
                                                Thank you for choosing to purchase a {{$plan->name}} plan with us. We are delighted to have you on board as our valued customer.<br><br>
                                                
                                                We hope that the plan you have chosen will provide you with the features and benefits you need to meet your goals. If you have any questions or concerns about your plan, please do not hesitate to contact our customer support team. They will be happy to assist you and address any queries you may have.<br><br>

                                                Once again, thank you for choosing us as your plan provider. We look forward to providing you with excellent service and support.<br><br><br>
